      ...
      var ChitterModel2 = class {
        ...
        setChitts(chitts) {
          chitts.forEach((chitt) => {
            ...
            if (typeof chitt.likes === "undefined") {
              counted_likes = 0;
            } else {
              counted_likes = chitt.likes.length;
            }
            let updated = chitt.created_at === chitt.updated_at;
            this.chitts.push({ user: chitt.user.handle, chitt: chitt.body, posted: time, id: chitt.user.id, likes: counted_likes, people_who_like: chitt.likes, updated });
          });
        }
      };
